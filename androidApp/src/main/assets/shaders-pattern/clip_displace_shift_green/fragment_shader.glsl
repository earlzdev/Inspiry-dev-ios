...
// Displacement x=-10px, y=2px
const float DISPLACEMENT_PIXEL_STEP_X = 10.0;
const float DISPLACEMENT_PIXEL_STEP_Y = -2.0;
// Green displcement x=10px
const float GREEN_DISPLACEMENT_PIXEL_STEP_X = -10.0;
const float GREEN_DISPLACEMENT_PIXEL_STEP_Y = 0.0;
...
void main() {
    ...
    vec2 rbCoord = displacement(vTextureCoord_0_, uPixelSize_0_, displacementMask, DISPLACEMENT_PIXEL_STEP_X, DISPLACEMENT_PIXEL_STEP_Y);
    vec2 gCoord = displacement(rbCoord, uPixelSize_0_, vec2(1.0, 1.0), GREEN_DISPLACEMENT_PIXEL_STEP_X, GREEN_DISPLACEMENT_PIXEL_STEP_Y);
