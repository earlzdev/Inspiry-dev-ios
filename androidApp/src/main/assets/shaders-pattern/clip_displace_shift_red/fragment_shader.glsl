...
const float DISPLACEMENT_PIXEL_STEP_X = 15.0;
const float DISPLACEMENT_PIXEL_STEP_Y = 0.0;
const float RED_DISPLACEMENT_PIXEL_STEP_X = -15.0;
const float RED_DISPLACEMENT_PIXEL_STEP_Y = -5.0;
...
void main() {
    ...
    vec2 gbCoord = displacement(vTextureCoord_0_, uPixelSize_0_, displacementMask, DISPLACEMENT_PIXEL_STEP_X, DISPLACEMENT_PIXEL_STEP_Y);
    vec2 rCoord = displacement(gbCoord, uPixelSize_0_, vec2(1.0, 1.0), RED_DISPLACEMENT_PIXEL_STEP_X, RED_DISPLACEMENT_PIXEL_STEP_Y);
