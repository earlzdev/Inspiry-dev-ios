 ...
 */
class ColorPickerView @JvmOverloads constructor(context: Context,
   ...
   */
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        huePanelWidthPx = DrawingUtils.dpToPx(getContext(), HUE_PANEL_WDITH_DP.toFloat())
        alphaPanelHeightPx = DrawingUtils.dpToPx(getContext(), ALPHA_PANEL_HEIGH_DP.toFloat())
        panelSpacingPx = DrawingUtils.dpToPx(getContext(), PANEL_SPACING_DP.toFloat())
        circleTrackerRadiusPx = DrawingUtils.dpToPx(getContext(),
            CIRCLE_TRACKER_RADIUS_DP.toFloat())
        sliderTrackerSizePx = DrawingUtils.dpToPx(getContext(), SLIDER_TRACKER_SIZE_DP.toFloat())
        sliderTrackerOffsetPx = DrawingUtils.dpToPx(getContext(),
            SLIDER_TRACKER_OFFSET_DP.toFloat())
    ...
    private fun drawSatValPanel(canvas: Canvas) {
        ...
        if (BORDER_WIDTH_PX > 0) {
            ...
            canvas.drawRect(drawingRect!!.left.toFloat(),
        ...
        if (valShader == null) {
            ...
            valShader = LinearGradient(rect!!.left.toFloat(),
                rect.top.toFloat(),
                rect.left.toFloat(),
                rect.bottom.toFloat(),
                -0x1,
        ...
        if (satValBackgroundCache == null || satValBackgroundCache!!.value != hue) {
            ...
            if (satValBackgroundCache!!.bitmap == null) {
                satValBackgroundCache!!.bitmap = Bitmap.createBitmap(rect!!.width(),
                    rect.height(),
            ...
            satShader = LinearGradient(rect!!.left.toFloat(),
                rect.top.toFloat(),
                rect.right.toFloat(),
                rect.top.toFloat(),
                -0x1,
            ...
            satValBackgroundCache!!.canvas!!.drawRect(0f,
                0f,
        ...
        canvas.drawCircle(p.x.toFloat(),
            p.y.toFloat(),
            circleTrackerRadiusPx - DrawingUtils.dpToPx(context, 1f).toFloat(),
            satValTrackerPaint!!)
    ...
    private fun drawHuePanel(canvas: Canvas) {
        ...
        if (hueBackgroundCache == null) {
            ...
            hueBackgroundCache!!.bitmap = Bitmap.createBitmap(rect!!.width(),
                rect.height(),
                Bitmap.Config.ARGB_8888)
            ...
            for (i in hueColors.indices) {
                ...
                hueBackgroundCache!!.canvas!!.drawLine(0f,
                    i.toFloat(),
                    hueBackgroundCache!!.bitmap!!.getWidth().toFloat(),
                    i.toFloat(),
                    linePaint)
            }
        }
     ...
     */
        ...
        alphaShader = LinearGradient(rect.left.toFloat(),
            rect.top.toFloat(),
            rect.right.toFloat(),
            rect.top.toFloat(),
            color,
        ...
        if (alphaSliderText != null && alphaSliderText != "") {
            canvas.drawText(alphaSliderText!!,
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        if (update) {
            if (onColorChangedListener != null) {
                onColorChangedListener!!.onColorChanged(Color.HSVToColor(alpha,
    ...
    private fun setUpHueRect() {
        ...
        val top = dRect.top + BORDER_WIDTH_PX
        val bottom = dRect.bottom - BORDER_WIDTH_PX - if (showAlphaPanel) panelSpacingPx + alphaPanelHeightPx else 0
    ...
    private fun setUpAlphaRect() {
        ...
        alphaPatternDrawable!!.setBounds(Math.round(alphaRect!!.left.toFloat()),
            Math.round(alphaRect!!.top.toFloat()),
    ...
    fun setColor(color: Int, callback: Boolean) {
        ...
        if (callback && onColorChangedListener != null) {
            onColorChangedListener!!.onColorChanged(Color.HSVToColor(this.alpha,
                floatArrayOf(hue, sat, `val`)))
        }
        invalidate()
    }
    ...
    companion object {
        private const val DEFAULT_BORDER_COLOR = -0x545455
        private const val DEFAULT_SLIDER_COLOR = -0xa5a5a6
